    ...
    >
      <div id="list-content" class="goods-list">
        <van-cell
            ...
            :key="index"
            @click="tapDetail(item.productId)"
        >
          <van-skeleton title avatar :row="3" :loading="loading">
            ...
            <div class="goods-info">
              ...
              <div class="info">
                ...
                <div class="cart-icon">
                  <img src="http://127.0.0.1:3000/images/addcatr.png" alt=""/>
                </div>
              </div>
            </div>
          </van-skeleton>
...
export default {
  ...
  mounted() {
    ...
    document.getElementById("list-content").style.minHeight =
        winHeight - 82 + "px"; //调整上拉加载框高度
  },
  methods: {
    getGoodsList() {
      let {pageSize, pageNum, optionId, searchText} = this;
      let params = {
        pageSize,
        pageNum,
        optionId,
